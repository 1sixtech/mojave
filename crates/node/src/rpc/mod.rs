...
#[cfg(test)]
mod tests {
    use crate::rpc::{tasks::spawn_block_processing_task, types::{OrderedBlock, PendingHeap}};
    ...
    use ethrex_rpc::{ActiveFilters, EthClient, GasTipEstimator, NodeData, RpcApiContext as L1Context};
